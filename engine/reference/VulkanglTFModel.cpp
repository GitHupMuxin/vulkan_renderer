...
#include "engine/resource/VulkanglTFModel.h"

namespace engine::resource::vkglTF
{
	...
	void Texture::fromglTfImage(tinygltf::Image &gltfimage, std::string path, TextureSampler textureSampler, core::VulkanDevice *device, VkQueue copyQueue)
	{
		this->device = device;
	...
	void Model::loadTextures(tinygltf::Model &gltfModel, core::VulkanDevice *device, VkQueue transferQueue)
	{
	...
	void Model::loadFromFile(std::string filename, core::VulkanDevice* device, VkQueue transferQueue, float scale)
	{
