...
namespace engine::resource::vkglTF
{
	...
	struct Texture {
		...
		void destroy();
		void fromglTfImage(tinygltf::Image& gltfimage, std::string path, TextureSampler textureSampler, core::VulkanDevice* device, VkQueue copyQueue);
	};
	...
	struct Model {
		...
		void loadTextures(tinygltf::Model& gltfModel, core::VulkanDevice* device, VkQueue transferQueue);
		VkSamplerAddressMode getVkWrapMode(int32_t wrapMode);
		VkFilter getVkFilterMode(int32_t filterMode);
		void loadTextureSamplers(tinygltf::Model& gltfModel);
		void loadMaterials(tinygltf::Model& gltfModel);
		void loadAnimations(tinygltf::Model& gltfModel);
		void loadFromFile(std::string filename, core::VulkanDevice* device, VkQueue transferQueue, float scale = 1.0f);
